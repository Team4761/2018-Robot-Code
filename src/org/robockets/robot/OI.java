...
import org.robockets.robot.cubeintake.ExchangeIntake;
...
public class OI {
	...
	public static Button driverX = new JoystickButton(driverJoystick, 3);
	...
	public OI() {
		...
		driverX.whileHeld(new Climb(-0.5));
		...
		operatorSelect.whileHeld(new ExchangeIntake(0.75));
		operatorStart.whileHeld(new ExchangeIntake(-0.75));
